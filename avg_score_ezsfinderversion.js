...
let GAME = GAMES.JSTRIS;

if (tempGame == "tetrio180") { // this saves me MUCH time :D
  GAME = GAMES.TETRIO;
} else if (tempGame == "srs") {
  GAME = GAMES.GUIDELINE;
}

let score_table_normal;
if (catOnly) {
  score_table_normal      = [   0,    0,    0,    0,  800];
} else {
  score_table_normal      = [   0,  100,  300,  500,  800];
}
